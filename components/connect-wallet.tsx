...
const WalletModal: React.FC<WalletModalProps> = ({ buttonClassName }) => {
  ...
  const defaultButtonClasses = "bg-white text-black px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-purple-500/20";
    ...
    <div className="relative z-50 flex items-center justify-center">
      {publicKey ? (
        <motion.button
          ...
          className={cn(connectedButtonClasses, buttonClassName)}
                ...
                {modalState === "connecting" && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-black">Back to wallet selection</span>
                    </motion.button>
                  </motion.div>
                )}
